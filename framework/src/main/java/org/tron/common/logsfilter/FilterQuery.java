...
public class FilterQuery {
    ...
    @Getter
    @Setter
    private List<String> rootContractList;
    @Getter
    @Setter
    private Long rootContractInitTimes;
    @Getter
    @Setter
    ...
    private static boolean filterContractAddress(ContractTrigger trigger,
    ...
    private static boolean filterContractTopicList(ContractTrigger trigger, List<String> topList) {
        ...
        if (trigger instanceof ContractLogTrigger) {
            hset = ((ContractLogTrigger) trigger).getTopicList().stream()
    ...
    public void addContractAddress(String newContract) {
        contractAddressList.add(newContract);
    }

    public boolean checkContractAddress(String newContract) {
        return contractAddressList.contains(newContract);
    }
}
