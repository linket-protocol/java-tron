...
public class Constant {
  ...
  public static final String SPLIT_BLOCK_NUM = "split_block_num";
    ...
    public static final long TRANSACTION_FEE_POOL_PERIOD = 1; //1 blocks// config for smart contract
  ...
  public static final String EVENT_SUBSCRIBE = "event.subscribe";
    ...
    public static final String EVENT_SUBSCRIBE_ROOT_CONTRACT = "event.subscribe.filter.rootContract";
    public static final String EVENT_SUBSCRIBE_ROOT_CONTRACT_INIT_TIMES = "event.subscribe.filter.rootContractInitTimes";
